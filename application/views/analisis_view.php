...
<div class="card shadow mb-4" id="not1" style="display: block;">
	...
	<div class="card-header">
		<h6 class="m-0 font-weight-bold text-primary">Lista de Solcitudes</h6>
	</div>
	<div class="col-md-2" style="margin-top: 5px">
		<button type="button" class="btn btn-info" title="Agregar Detalle" id="btnAgregar">Agregar</button>
	</div>
	<!-- Card Body -->
	<div class="card-body">
...
<div class="col-xl-12" id="not2" style="display: none;" >
	...
	<label id="lblDetalleEliminar" style="display: none;"></label>
    <div class="card shadow mb-4">
        ...
        <div class="card-header d-flex flex-row align-items-center justify-content-between" style="padding-top: 5px; padding-bottom: 5px">
            <h6 class="m-0 font-weight-bold text-primary">Solcitud</h6>
            <div class="dropdown no-arrow">      					
			    <button type="button" class="btn btn-info" title="Agregar" id="btnAddComp">Guardar</button>
			    <button type="button" class="btn btn-info" title="Agregar" id="btnCancelaredit">Cancelar</button>
        	</div>
	    </div>
        <!-- Card Body -->
        <div class="card-body">
...
<div class="col-xl-12" id="not3" style="display: none;" >
    <div class="card shadow mb-4">
        ...
        <div class="card-header d-flex flex-row align-items-center justify-content-between" style="padding-top: 5px; padding-bottom: 5px">
            ...
            <div class="dropdown no-arrow">      					
			    <button type="button" class="btn btn-info" title="Atras" id="btnCancelarresult">Atras</button>
        	</div>
	    </div>
        <!-- Card Body -->
        <div class="card-body">
...
<!-- Modal imagen-->
<div id="modalImagen" class="modal fade bd-example-modal-xl" role="dialog">
...
<script src="<?php echo APP_PATH_JS; ?>solicitud.js"></script>