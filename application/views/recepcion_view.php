...
<div class="card shadow mb-4" id="not1" style="display: block;">
	...
	<div class="card-header">
		<h6 class="m-0 font-weight-bold text-primary">Lista de Solicitudes Pendientes</h6>
	</div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header d-flex flex-row align-items-center justify-content-between" style="padding-top: 5px; padding-bottom: 5px">
            ...
            <div class="dropdown no-arrow">      					
			    <button type="button" class="btn btn-info" title="Agregar" id="btnCancelaredit">Atras</button>
        	</div>
	    </div>
        <!-- Card Body -->
        <div class="card-body">
...
<div id="asignarModal" class="modal fade bd-example-modal-md" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
             ...
             <div class="container-90">
				    <div class="row">
				    	<div class="col-md-12 col-xs-12">	
							<div class="ui-widget ui-front">
								<label for="responsable">Responsable:<span class="campoObligatorio">*</span></label>
								<input id="responsable" class="form-control"  />
								<input id="responsableId" class="form-control" type="hidden" name="Responsable" />
							</div>
						</div>								
					</div>
	            </div>   
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="btnAsignar" >Aceptar</button>
...
<script src="<?php echo APP_PATH_JS; ?>recepcion.js"></script>